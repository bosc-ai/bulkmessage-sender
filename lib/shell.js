...
const LOGO = "/assets/wachat-logo.png";
        ...
        <div class="container">
          <div class="footer-top">
            ...
            <div class="footer-col">
              <h2>Solutions</h2>
              <ul>
                <li><a href="/use-cases#d2c">D2C &amp; e-commerce</a></li>
                <li><a href="/use-cases#education">Education</a></li>
                <li><a href="/use-cases#finance">Financial services</a></li>
                <li><a href="/use-cases#healthcare">Healthcare</a></li>
                <li><a href="/use-cases#logistics">Logistics &amp; travel</a></li>
              </ul>
            </div>
            <div class="footer-col">
              <h2>Resources</h2>
...
export function injectShell(html) {
  ...
  return html
    ...
    .replace(/<div id="wc-footer">\s*<\/div>/, `<div id="wc-footer">${footerHtml()}</div>`);
}
